...
{
    public class RRD : EdInstruction
    {
        public override uint Cycles => 18;
        public override byte[] OpCodes { get; } = { 0b01100111 };

        public RRD(Z80 z80) : base(z80) { }

        protected override void InnerExecute(byte opCode)
        {
            var value = Z80.Memory[Z80.Registers.HL];

            Z80.Memory[Z80.Registers.HL] = (byte)(((Z80.Registers.A & 0b00001111) << 4) | ((value & 0b11110000) >> 4));
            Z80.Registers.A = (byte)((Z80.Registers.A & 0b11110000) | (value & 0b00001111));
